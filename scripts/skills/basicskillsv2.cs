RPGSkill::BasicSkill::AddSkillCatagory("Basic","Basic Skills");
RPGSkill::catagoryAddUITag("Basic","Name");
RPGSkill::catagoryAddUITag("Basic","Desc");
RPGSkill::catagoryAddUITag("Basic","Command");
RPGSkill::catagoryAddUITag("Basic","Reqs");
RPGSkill::catagoryAddUITag("Basic","Example");

RPGSkill::catagoryUIInfoLine("Basic",0,"<font:Verdana Bold:16><color:ffcc00><just:center>","Name");
RPGSkill::catagoryUIInfoLine("Basic",1,"",""); //Blank info and tag interpret to new line.
RPGSkill::catagoryUIInfoLine("Basic",2,"<just:left><font:Arial Bold:14><color:F5F5DC>Description:","");
RPGSkill::catagoryUIInfoLine("Basic",3,"<font:Arial:14>","Desc");
RPGSkill::catagoryUIInfoLine("Basic",4,"","");
RPGSkill::catagoryUIInfoLine("Basic",5,"<font:Arial:14>Command: ","Command");
RPGSkill::catagoryUIInfoLine("Basic",6,"","");
RPGSkill::catagoryUIInfoLine("Basic",7,"<font:Arial Bold:14>Skill Requirements:","");
RPGSkill::catagoryUIInfoLine("Basic",8,"<font:Arial:14>","Reqs");
RPGSkill::catagoryUIInfoLine("Basic",9,"","");
RPGSkill::catagoryUIInfoLine("Basic",10,"<font:Arial Bold:14>Example:","");
RPGSkill::catagoryUIInfoLine("Basic",11,"<font:Arial:14>","Example");

function RPGSkill::BasicSkill::AddSkill(%cmd,%name,%cat,%type,%func)
{
	RPGSkill::AddSkill(%cmd,%cat,%type,%func);
	RPGSkill::AddUIInfo(%cmd,"Name",%name);
}

//Speaking skills
//RPGSkill::BasicSkill::AddSkill(%cmd,%name,%cat,%type,%func)
RPGSkill::BasicSkill::AddSkill("#say","Say","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#whisper","Whisper","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#tell","Tell","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#zone","Zone Talk","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#party","Party Talk","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#shout","Shout","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#global","Global Talk","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#group","Group Talk","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#guild","Guild Talk","Basic",$Skill::Speech,"BasicSkillsay");
RPGSkill::BasicSkill::AddSkill("#r","Tell Respond","Basic",$Skill::Speech,"BasicSkillsay");

RPGSkill::AddUIInfo("#say"
...
RPGSkill::BasicSkill::AddSkill("#compass","Compass","Basic",$Skill::SenseHeading,"BasicSkillcompass");
RPGSkill::BasicSkill::AddSkill("#track","Track","Basic",$Skill::SenseHeading,"BasicSkilltrack");
RPGSkill::BasicSkill::AddSkill("#advcompass","Advanced Compass","Basic",$Skill::SenseHeading,"BasicSkilladvcompass");
RPGSkill::BasicSkill::AddSkill("#zonelist","Zone List","Basic",$Skill::SenseHeading,"BasicSkillzonelist");
RPGSkill::BasicSkill::AddSkill("#trackpack","Track Pack","Basic",$Skill::SenseHeading,"BasicSkilltrackpack");
...
//Backstab Skills
RPGSkill::BasicSkill::AddSkill("#backstab","Backstab","Basic",$Skill::Backstabbing,"BasicSkillbackstab");
RPGSkill::BasicSkill::AddSkill("#surge","Surge","Basic",$Skill::Backstabbing,"BasicSkillsurge");
RPGSkill::BasicSkill::AddSkill("#encumber","Encumbering Strike","Basic",$Skill::Backstabbing,"BasicSkillencumber");
...
//Ignite Skills
RPGSkill::BasicSkill::AddSkill("#ignite","Ignite Arrow","Basic",$Skill::IgniteArrow,"BasicSkillignite");
...
//Cleave Skills
RPGSkill::BasicSkill::AddSkill("#cleave","Cleave","Basic",$Skill::Cleaving,"BasicSkillcleave");
RPGSkill::BasicSkill::AddSkill("#berserk","Berserk","Basic",$Skill::Cleaving,"BasicSkillberserk");
RPGSkill::BasicSkill::AddSkill("#targetleg","Target Leg","Basic",$Skill::Cleaving,"BasicSkilltargetleg");
...
//Stealing Skills
RPGSkill::BasicSkill::AddSkill("#steal","Steal","Basic",$Skill::Stealing,"BasicSkillsteal");
RPGSkill::BasicSkill::AddSkill("#pickpocket","Pickpocket","Basic",$Skill::Stealing,"BasicSkillpickpocket");
RPGSkill::BasicSkill::AddSkill("#mug","Mug","Basic",$Skill::Stealing,"BasicSkillmug");
...
//Hide Skills
RPGSkill::BasicSkill::AddSkill("#hide","Hide in Shadows","Basic",$Skill::Hiding,"BasicSkillhide");
...
//Focus Skills
RPGSkill::BasicSkill::AddSkill("#focus","Focus","Basic",$Skill::Focus,"BasicSkillfocus");
...
//Bashing Skills
RPGSkill::BasicSkill::AddSkill("#shove","Shove","Basic",$Skill::Bashing,"BasicSkillshove");
RPGSkill::BasicSkill::AddSkill("#bash","Bash","Basic",$Skill::Bashing,"BasicSkillbash");
RPGSkill::BasicSkill::AddSkill("#disrupt","Disrupt","Basic",$Skill::Bashing,"BasicSkilldisrupt");
RPGSkill::BasicSkill::AddSkill("#stun","Stun","Basic",$Skill::Bashing,"BasicSkillstun");
